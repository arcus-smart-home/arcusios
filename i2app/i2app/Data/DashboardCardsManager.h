...
#define kCardOrderupdated @"dashboardCardOrderUpdated"

@interface DashboardCardsManager : NSObject

+ (DashboardCardsManager *)shareInstance;

@property (nonatomic, readonly) NSArray *allCards;
@property (nonatomic, readonly) NSArray *enabledCards;
