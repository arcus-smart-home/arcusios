//
//  AddAPlaceGuestPinCodeViewController.swift
//  i2app
//
...
class AddAPlaceGuestPinCodeViewController: ArcusPinCodeViewController {
  ...
  override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    guard let pinCodeConfirmVC = segue.destination as? AddAPlaceGuestPinCodeConfirmationViewController else {
      return
    }
