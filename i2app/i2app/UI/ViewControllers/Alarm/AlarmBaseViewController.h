...
@class AlarmTabBarViewController;

@interface AlarmBaseViewController : UIViewController <UITableViewDelegate, UITableViewDataSource>
...
@property (weak, nonatomic) AlarmTabBarViewController *owner;
...
@interface AlarmBaseViewControllerCell : UITableViewCell

- (void)setTitle:(NSString *)title subtitle:(NSString *)subtitle;
- (void)setLogo:(UIImage *)logo;
- (void)setLogos:(NSArray *)logos;

@property (weak, nonatomic) IBOutlet UIScrollView *iconScroller;
