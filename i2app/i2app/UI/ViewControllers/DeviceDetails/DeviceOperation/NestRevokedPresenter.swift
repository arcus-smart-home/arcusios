...
protocol NestRevokedPresenterProtocol {
  /**
...
protocol NestRevokedPresenterDelegate: class {
  
}

class NestRevokedPresenter: NestRevokedPresenterProtocol {

  // MARK: Properties
  
  weak var delegate: NestRevokedPresenterDelegate?
  private(set) var product: DeviceProductCatalog?
  
  // MARK: Functions 
  
  init(delegate: NestRevokedPresenterDelegate) {
