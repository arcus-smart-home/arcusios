//
//  SmartFobSelectionViewController.h
//  i2app
//
...
@interface SmartFobPairingSelectionController : BasePairingViewController
...
@interface SmartFobPairingSelectionControllerCell: UITableViewCell
