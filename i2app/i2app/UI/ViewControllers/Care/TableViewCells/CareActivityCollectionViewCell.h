//
//  CareActivityCollectionViewCell.h
//  i2app
//
...
@interface CareActivityCollectionViewCell : UICollectionViewCell

@property (nonatomic, strong) IBOutlet ActivityGraphView *graphView;
