...
__attribute__((deprecated(("Cell is a duplicate of ArcusSelectOptionTableViewCell.  Please use ArcusSelectOptionTableViewCell instead."))))
@interface ArcusCheckableCell : UITableViewCell
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *descriptionLabelRightHorizontalConstraint;
