...
@property (nonatomic) float heightPadding;

@property (nonatomic) float widthPadding;
/**
...
@property (assign, nonatomic) id<EFCircularSliderDelegate> delegate;
...
@property (nonatomic, assign) BOOL shouldUpdateBrightness;
/**
