...
@objc class ArcusColorSelectionViewController: ArcusNormalColorTempSelectionViewController {
  override class func create() -> ArcusColorSelectionViewController {
    let storyboard: UIStoryboard = UIStoryboard(name: "ColorSelection", bundle:nil)
    return (storyboard
      .instantiateViewController(withIdentifier: String(describing: ArcusColorSelectionViewController.self))
      as? ArcusColorSelectionViewController)!
  }
