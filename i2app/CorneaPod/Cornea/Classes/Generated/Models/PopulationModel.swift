...
public class PopulationModel: Model, LegacyModelNotifier {
  // MARK: LegacyModel Methods

  public static func addressForId(_ modelId: String) -> String {
    return addressForNamespace(Constants.populationNamespace, modelId: modelId)
  }

  public static func addModelNotificationName() -> String {
    return "AddPopulationModelNotification"
  }

  public static func updateModelNotificationName() -> String {
    return "UpdatePopulationModelNotification"
  }
}
