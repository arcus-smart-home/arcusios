//
//  CareAddEditBehaviorViewController.h
//  i2app
//
...
@interface CareAddEditBehaviorViewController : UIViewController<UITableViewDataSource, UITableViewDelegate, ArcusModalSelectionDelegate>
