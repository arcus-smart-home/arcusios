...
public class SchedulerModel: Model, LegacyModelNotifier {
  // MARK: LegacyModel Methods

  public static func addressForId(_ modelId: String) -> String {
    return addressForNamespace(Constants.schedulerNamespace, modelId: modelId)
  }

  public static func addModelNotificationName() -> String {
    return "AddSchedulerModelNotification"
  }

  public static func updateModelNotificationName() -> String {
    return "UpdateSchedulerModelNotification"
  }
}
