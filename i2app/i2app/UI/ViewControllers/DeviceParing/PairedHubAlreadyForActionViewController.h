//
//  PairedHubAlreadyForActionViewController.h
//  i2app
//
...
@interface PairedHubAlreadyForActionViewController : BasePairingViewController
...
@interface PairedHubAlreadyForActionCell: UITableViewCell
