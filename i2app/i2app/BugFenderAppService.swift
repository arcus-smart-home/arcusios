...
private enum BugfenderInfo {
  static let appToken = "ZuBJLkG8ndsJc6hJQ6IVKipcRhuyDuvB"
}

/**

 */
class BugFenderAppService: ArcusApplicationServiceProtocol {
