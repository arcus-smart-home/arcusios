...
@class RuleOccurModel;
@class RuleDetailModel;

@interface RuleScheduleViewController : UIViewController

@end

@interface RuleScheduleViewControllerCell : UITableViewCell
