//
//  SmartSheetChooseViewController.h
//  i2app
//
...
@class SmartStreetTextField;
@class SmartyStreetsAddress;

@interface SmartStreetChooseViewController : UIViewController
...
@interface SmartStreetChooseViewCell: UITableViewCell
