//
//  AlarmNotificationSecurityRecommendationInfoViewController.swift
//  i2app
//
...
/// Displayed by the AlarmNotificationListViewController using a segue located in the storyboard
class AlarmNotificationSecurityRecommendationInfoViewController: UIViewController {
