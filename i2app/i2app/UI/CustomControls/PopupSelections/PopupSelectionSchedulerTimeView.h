//
//  PopupSelectionSchedulerTimeView.h
//  i2app
//
...
@interface PopupSelectionSchedulerTimeView : PopupSelectionTimerView
...
@property (strong, nonatomic) ArcusDateTime *currentDateTime;
