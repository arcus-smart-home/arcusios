...
@interface WifiScanResultModel : NSObject

@property (nonatomic, strong) NSNumber *channel;
@property (nonatomic, strong) NSString *encryption;
@property (nonatomic, strong) NSString *mode;
@property (nonatomic, strong) NSArray *security;
@property (nonatomic, strong) NSNumber *signal;
@property (nonatomic, strong) NSString *ssid;
@property (nonatomic, strong) NSString *wepauth;
@property (nonatomic, assign) BOOL wps;
