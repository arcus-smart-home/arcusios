//
//  TiltSensorPairingStepViewController.h
//  i2app
//
...
@interface TiltSensorPairingStepViewController : BasePairingViewController

+ (instancetype)createWithDeviceStep:(PairingStep *)step device:(DeviceModel*)deviceModel;

@end

@interface TiltSelectionViewControllerCell: UITableViewCell
