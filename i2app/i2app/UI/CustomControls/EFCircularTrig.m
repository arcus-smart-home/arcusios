...
+ (void)drawUnfilledCircleInContext:(CGContextRef)ctx
    ...
    [self drawUnfilledArcInContext:ctx center:center radius:radius lineWidth:lineWidth  fromAngleFromNorth:210 toAngleFromNorth:150 withShadow:NO withBrightnessLevel:0.0f]; // 0 - 360 is full circle
}
...
+ (void)drawUnfilledArcInContext:(CGContextRef)ctx
              ...
              fromAngleFromNorth:(CGFloat)fromAngleFromNorth
                toAngleFromNorth:(CGFloat)toAngleFromNorth
                      withShadow:(BOOL)shouldShowShadow
             withBrightnessLevel:(float)brightnessLevel {
    ...
    ////////////////////////////////////////////////draw inner and outer light/////////////////////////////////////////////////////////////////
    if (shouldShowShadow && fromAngleFromNorth != toAngleFromNorth) {
        CGContextSetShadowWithColor(ctx, CGSizeMake(3.0f, 3.0f), 10.0f, [[UIColor colorWithWhite:1.0 alpha:brightnessLevel/100.0f] CGColor]);
