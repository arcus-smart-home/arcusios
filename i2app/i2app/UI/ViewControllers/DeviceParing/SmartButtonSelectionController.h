//
//  SmartButtonSelectionController.h
//  i2app
//
...
@interface SmartButtonSelectionController : BasePairingViewController
...
@interface SmartButtonSelectionControllerCell: UITableViewCell
